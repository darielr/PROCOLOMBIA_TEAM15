...
def wordcloud_func(corpus, country):
    ...
    fig.savefig(path + country + "_wordcloud1.png")
...
def uni_big_trig(corpus, country):
    ...
    barchartOnegram = px.bar(x = top_df['Word'], y = top_df['Freq'], title = 'BarOnegram', labels = dict( x = 'Word', y = 'Freq'))
    barchartBigram = px.bar(x = top2_df['Bi-gram'], y = top2_df['Freq'], title = 'BarBigram', labels = dict( x = 'Bi-gram', y = 'Freq'))
    barchartTrigram = px.bar(x = top3_df['Tri-gram'], y = top3_df['Freq'], title = 'BarTrigram', labels = dict( x = 'Tri-gram', y = 'Freq'))
...
new_words = ['http', 'rt', 'colombia', 'colombian']
